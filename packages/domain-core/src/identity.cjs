...
} = require("../../contracts/src/identity.cjs");
...
function normalizeRuntimeNumericId(value) {
  const normalized = trimText(value);
  return /^\d+$/.test(normalized) ? normalized : "";
}

function createSessionDescriptor(claims = {}) {
...
function hasEnterpriseSessionShape(claims = {}) {
...
function buildRuntimePrincipalIdentity(source = {}, options = {}) {
...
function mergeRuntimePrincipalIdentity(sources = [], options = {}) {
...
function createAdminRuntimeIdentity(sources = [], options = {}) {
...
function resolveSocketSubjectId(claimedUserId, identities = [], options = {}) {
...
function createSocketSessionIdentity(identity, options = {}) {
