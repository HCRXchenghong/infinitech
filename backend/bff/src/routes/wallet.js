...
router.get('/recharge/options', walletController.getRechargeOptions);
router.post('/recharge', walletController.recharge);
router.post('/recharge/intent', walletController.recharge);
...
router.post('/withdraw/apply', walletController.withdraw);
router.get('/withdraw/status', walletController.getWithdrawStatus);
router.get('/withdraw/status/:requestId', walletController.getWithdrawStatusById);
