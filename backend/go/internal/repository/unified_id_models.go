...
//
// UID format: 250724 + bucket(2) + 10-digit sequence (18 chars)
// TSID format: 250724 + bucket(2) + yymmddHHMM + 10-digit sequence (28 chars)
type UnifiedIdentity struct {
	UID  string `gorm:"column:uid;size:18;index;uniqueIndex" json:"id,omitempty"`
	TSID string `gorm:"column:tsid;size:28;index;uniqueIndex" json:"tsid,omitempty"`
}
...
type IDSequence struct {
	...
	WarnThreshold int64     `gorm:"default:9500000000;not null" json:"warn_threshold"`
	CreatedAt     time.Time `json:"created_at"`
	UpdatedAt     time.Time `json:"updated_at"`
}
...
type IDLegacyMapping struct {
	...
	UID         string    `gorm:"column:uid;size:18;index;not null;uniqueIndex" json:"uid"`
	TSID        string    `gorm:"column:tsid;size:28;index;uniqueIndex" json:"tsid"`
	CreatedAt   time.Time `json:"created_at"`
}
