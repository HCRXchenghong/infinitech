...
export function useHomeCampaignsPage({ request, ElMessage }) {
  ...
  return {
    campaigns,
    canAction: canAdminHomeCampaignPerformAction,
    changeStatus,
    dialogTitle,
    dialogVisible,
    filters,
    form,
    formatPositionSource: getAdminHomeCampaignPositionSourceLabel,
    formatStatus: getAdminHomeCampaignStatusLabel,
    handleFilterQuery,
    handleObjectTypeChange,
    loadAll,
    loading,
    lockLabel: getAdminHomeCampaignLockLabel,
    lockTagType: getAdminHomeCampaignLockTagType,
    objectTypeLabel: getAdminHomeCampaignObjectTypeLabel,
    objectTypeTagType: getAdminHomeCampaignObjectTypeTagType,
    openDialog,
    pageError,
    positionSourceTagType: getAdminHomeCampaignPositionSourceTagType,
    promoteLabel: getAdminHomeCampaignPromoteLabel,
    slotProducts,
    slotShops,
    statusTagType: getAdminHomeCampaignStatusTagType,
    submitForm,
    submitting,
    targetOptions,
  }
