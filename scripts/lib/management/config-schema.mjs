...
const COMMON_ENV_METADATA = {
  ...
  SYSTEM_LOG_DELETE_ACCOUNT: { label: '敏感操作验证账号', group: '初始化与安全', type: 'string', description: '系统日志/清空操作二次验证账号。', common: true },
  SYSTEM_LOG_DELETE_PASSWORD: { label: '敏感操作验证密码', group: '初始化与安全', type: 'secret', description: '系统日志/清空操作二次验证密码。', common: true },
