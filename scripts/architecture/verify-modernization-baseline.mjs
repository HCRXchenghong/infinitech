...
[
  "scripts/architecture/check-admin-shell-duplicates.mjs",
  "scripts/architecture/check-admin-shell-duplicates.test.mjs",
  ...
  "packages/admin-core/src/desktop-shell-base.css",
  "packages/admin-core/src/desktop-shell-bootstrap.js",
  "packages/admin-core/src/desktop-shell-bootstrap.d.ts",
  "packages/admin-core/src/desktop-shell-vite.js",
  "packages/admin-core/src/desktop-shell-vite.d.ts",
  "packages/admin-core/src/desktop-shell-vite.test.mjs",
  ...
  "packages/mobile-core/src/consumer-auth-session.js",
  "packages/mobile-core/src/consumer-auth-session.test.mjs",
  "packages/mobile-core/src/consumer-profile-storage.js",
  "packages/mobile-core/src/consumer-profile-storage.test.mjs",
  ...
  "packages/mobile-core/src/consumer-errand-runtime-shell.js",
  "packages/mobile-core/src/consumer-errand-runtime-shell.test.mjs",
  ...
  "packages/mobile-core/src/consumer-request-interceptor-shell.js",
  "packages/mobile-core/src/consumer-request-interceptor-shell.test.mjs",
  ...
  "packages/mobile-core/src/rider-login-page.js",
  "packages/mobile-core/src/rider-login-page.test.mjs",
  ...
  "packages/mobile-core/src/rider-reset-password-page.js",
  "packages/mobile-core/src/rider-reset-password-page.test.mjs",
  "packages/mobile-core/src/rider-profile-settings-page.js",
  "packages/mobile-core/src/rider-profile-settings-page.test.mjs",
  "packages/mobile-core/src/rider-set-password-page.js",
  "packages/mobile-core/src/rider-set-password-page.test.mjs",
...
[
  ...
  ["rider-app/pages/login/index.vue", "../../../packages/mobile-core/src/rider-login-page.js"],
  ["rider-app/pages/reset-password/index.vue", "../../../packages/mobile-core/src/rider-reset-password-page.js"],
  ["rider-app/pages/set-password/index.vue", "../../../packages/mobile-core/src/rider-set-password-page.js"],
  ...
  [
    "rider-app/pages/tasks/detail-logic.ts",
    "../../../packages/mobile-core/src/rider-task-detail-page.js",
  ],
  [
...
assertContains("admin-vue/src/router/index.js", "adminProtectedRouteRecords");
assertContains("admin-vue/src/router/index.js", "buildAdminRouteMeta");
assertContains(
...
assertNotContains("rider-app/pages/profile/rider-home.vue", "DEFAULT_RANK_CONFIG");
assertNotContains("rider-app/pages/profile/rider-home.vue", "function buildRankConfig");
assertNotContains("rider-app/pages/profile/rider-home.vue", "renderProgressText()");
assertContains(
  "rider-app/pages/profile/index-logic.ts",
  "from '../../../packages/mobile-core/src/rider-profile-home-page.js'",
);
assertContains(
  "rider-app/pages/profile/index-logic.ts",
  "createRiderProfileHomePageLogic",
);
assertNotContains("rider-app/pages/profile/index-logic.ts", "const RANK_NAME_MAP");
assertNotContains(
  "rider-app/pages/profile/index-logic.ts",
...
assertContains(
  "rider-app/pages/tasks/detail-logic.ts",
  "from '../../../packages/mobile-core/src/rider-task-detail-page.js'",
);
assertContains(
  "rider-app/pages/tasks/detail-logic.ts",
  "createRiderTaskDetailPageLogic",
);
assertNotContains("rider-app/pages/tasks/detail-logic.ts", "formatTaskDistance(task: any)");
assertNotContains("rider-app/pages/tasks/detail-logic.ts", "async handleReport(reason: string)");
assertNotContains("rider-app/pages/tasks/detail-logic.ts", "completeTask()");
assertContains(
  "rider-app/pages/profile/settings.vue",
...
assertContains(
  ...
  "from '../../../packages/mobile-core/src/rider-login-page.js'",
);
assertContains("rider-app/pages/login/index.vue", "createRiderLoginPageLogic");
assertContains("rider-app/pages/login/index.vue", "persistRiderAuthSession,");
assertContains("rider-app/pages/login/index.vue", "riderLogin,");
assertNotContains("rider-app/pages/login/index.vue", "const result = await requestRoleLoginCode({");
assertNotContains("rider-app/pages/login/index.vue", "persistRoleAuthSessionFromAuthResult({");
assertNotContains("rider-app/pages/login/index.vue", "sendingCode: false");
assertNotContains("rider-app/pages/login/index.vue", "submitting: false");
...
assertContains(
  ...
  "from '../../../packages/mobile-core/src/rider-reset-password-page.js'",
);
assertContains("rider-app/pages/reset-password/index.vue", "createRiderResetPasswordPageLogic");
assertContains(
  "rider-app/pages/reset-password/index.vue",
  "verifySMSCodeCheck,",
);
assertNotContains("rider-app/pages/reset-password/index.vue", "createRolePasswordResetCooldownController({");
assertNotContains("rider-app/pages/reset-password/index.vue", "const result = await requestRolePasswordResetCode({");
assertNotContains("rider-app/pages/reset-password/index.vue", "const result = await verifyRolePasswordResetCode({");
assertNotContains("rider-app/pages/reset-password/index.vue", "sendingCode: false");
assertNotContains("rider-app/pages/reset-password/index.vue", "submitting: false");
...
assertContains(
  ...
  "from '../../../packages/mobile-core/src/rider-set-password-page.js'",
);
assertContains("rider-app/pages/set-password/index.vue", "createRiderSetPasswordPageLogic");
assertContains("rider-app/pages/set-password/index.vue", "submitSetNewPassword:");
assertNotContains("rider-app/pages/set-password/index.vue", "resolveRolePasswordResetTicket(");
assertNotContains("rider-app/pages/set-password/index.vue", "const result = await submitRolePasswordResetNextPassword({");
assertNotContains("rider-app/pages/set-password/index.vue", "submitting: false");
...
assertContains(
  ...
  "resolveProtectedView(item.view || item.name)",
);
assertNotContains(
  "admin-vue/src/router/index.js",
...
assertContains(
  "package.json",
  '"verify:admin-core-tests": "node --test packages/admin-core/src/admin-auth-session.test.mjs packages/admin-core/src/admin-auth-response.test.mjs packages/admin-core/src/desktop-shell-vite.test.mjs packages/admin-core/src/route-registry.test.mjs packages/admin-core/src/navigation-metadata.test.mjs packages/admin-core/src/paginated-resources.test.mjs packages/admin-core/src/system-log-resources.test.mjs packages/admin-core/src/payment-center-resources.test.mjs packages/admin-core/src/service-health-resources.test.mjs packages/admin-core/src/official-site-resources.test.mjs packages/admin-core/src/financial-transaction-resources.test.mjs packages/admin-core/src/notification-resources.test.mjs packages/admin-core/src/content-settings-resources.test.mjs packages/admin-core/src/operations-center-resources.test.mjs packages/admin-core/src/dashboard-resources.test.mjs packages/admin-core/src/system-settings-resources.test.mjs packages/admin-core/src/api-management-resources.test.mjs packages/admin-core/src/order-resources.test.mjs packages/admin-core/src/user-management-resources.test.mjs packages/admin-core/src/shop-management-resources.test.mjs packages/admin-core/src/merchant-profile-resources.test.mjs packages/admin-core/src/home-entry-resources.test.mjs packages/admin-core/src/communication-audit-resources.test.mjs packages/admin-core/src/home-campaign-resources.test.mjs packages/admin-core/src/admin-management-resources.test.mjs packages/admin-core/src/dining-buddy-governance-resources.test.mjs packages/admin-core/src/chat-console-resources.test.mjs packages/admin-core/src/data-management-resources.test.mjs packages/admin-core/src/coupon-resources.test.mjs packages/admin-core/src/api-documentation-resources.test.mjs"',
);
assertContains(
  "package.json",
...
assertContains(
  "user-vue/shared-ui/request-interceptor.ts",
  'from "../../packages/mobile-core/src/consumer-request-interceptor-shell.js"',
);
assertContains(
  "user-vue/shared-ui/request-interceptor.ts",
  "createConsumerUserRequestInterceptorBindings({",
...
assertContains(
  "user-vue/shared-ui/errand-runtime.js",
  'from "../../packages/mobile-core/src/consumer-errand-runtime-shell.js"',
);
assertContains(
  "user-vue/shared-ui/errand-runtime.js",
  "createConsumerUserErrandRuntimeBindings({",
...
assertContains(
  "packages/mobile-core/src/index.js",
  'export * from "./consumer-errand-runtime-shell.js";',
);
assertContains(
  "packages/mobile-core/src/index.js",
...
assertContains(
  "packages/mobile-core/src/index.js",
  'export * from "./consumer-request-interceptor-shell.js";',
);
assertContains(
  "packages/mobile-core/src/index.js",
...
assertContains(
  "packages/mobile-core/src/index.js",
  'export * from "./rider-login-page.js";',
);
assertContains(
  "packages/mobile-core/src/index.js",
...
assertContains(
  "packages/mobile-core/src/index.js",
  'export * from "./rider-set-password-page.js";',
);
assertContains(
  "packages/mobile-core/src/index.js",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./rider-login-page": "./src/rider-login-page.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./rider-task-detail-page": "./src/rider-task-detail-page.js"',
);
assertContains(
  "packages/mobile-core/package.json",
  '"./rider-profile-home-page": "./src/rider-profile-home-page.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./rider-reset-password-page": "./src/rider-reset-password-page.js"',
);
assertContains(
  "packages/mobile-core/package.json",
  '"./rider-set-password-page": "./src/rider-set-password-page.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./consumer-auth-session": "./src/consumer-auth-session.js"',
);
assertContains(
  "packages/mobile-core/package.json",
  '"./consumer-profile-storage": "./src/consumer-profile-storage.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./consumer-errand-runtime-shell": "./src/consumer-errand-runtime-shell.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains(
  "packages/mobile-core/package.json",
  '"./consumer-request-interceptor-shell": "./src/consumer-request-interceptor-shell.js"',
);
assertContains(
  "packages/mobile-core/package.json",
...
assertContains("rider-app/pages/login/index.vue", "createRiderLoginPageLogic");
assertContains("packages/mobile-core/src/rider-login-page.js", "该手机号不是骑手账号，请使用骑手账号登录");
assertContains("packages/mobile-core/src/rider-login-page.js", "登录密码错误，请重试");
assertContains("rider-app/pages/reset-password/index.vue", "createRiderResetPasswordPageLogic");
assertContains("packages/mobile-core/src/rider-reset-password-page.js", 'RIDER_RESET_PASSWORD_SCENE = "rider_reset"');
assertContains("packages/mobile-core/src/rider-reset-password-page.js", "verifySMSCodeCheck,");
assertContains("rider-app/pages/set-password/index.vue", "createRiderSetPasswordPageLogic");
assertContains("packages/mobile-core/src/rider-set-password-page.js", "请先完成验证码校验");
assertContains("packages/mobile-core/src/rider-set-password-page.js", "密码设置成功");
...
assertContains("rider-app/pages/tasks/detail-logic.ts", "createRiderTaskDetailPageLogic");
assertContains("packages/mobile-core/src/rider-task-detail-page.js", "订单已完成！");
assertContains("packages/mobile-core/src/rider-task-detail-page.js", "上报成功");
