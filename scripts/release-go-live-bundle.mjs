...
async function main() {
  ...
  const manifest = {
    ...
    executionOrder: [
      ...
      '6. Run rtc-real-device-prep and store the report in reports/rtc-real-device-prep.json.',
      '7. Run release-manual-attestation-prefill to generate manual-attestation/prefilled.json from the drill reports.',
      '8. Complete manual-attestation/completed.json with real-device push, RTC, and failure-recovery evidence.',
      '9. Run release-final-signoff and store the report in reports/final-signoff.json.',
    ],
    templateExitCode,
  };
