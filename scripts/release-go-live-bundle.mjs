...
async function main() {
  ...
  const manifest = {
    ...
    executionOrder: [
      ...
      '5. Run failure-drill-prep and store the report in reports/failure-drill-prep.json.',
      '6. Run release-evidence-gate and store the report in reports/evidence-gate.json.',
      '7. Run rtc-real-device-prep and store the report in reports/rtc-real-device-prep.json.',
      '8. Run release-manual-attestation-prefill to generate manual-attestation/prefilled.json from the drill reports.',
      '9. Complete manual-attestation/completed.json with real-device push, RTC, and failure-recovery evidence.',
      '10. Run release-final-signoff and store the report in reports/final-signoff.json.',
    ],
    templateExitCode,
  };
