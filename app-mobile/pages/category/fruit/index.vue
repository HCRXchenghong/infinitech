<template>
  <view class="page category-page">
    <PageHeader title="蔬菜水果" :showSearch="true" @search="goSearch" />
...
export default {
  ...
  computed: {
    filteredShops() {
      ...
      shops = shops.filter(shop => shop.tags && shop.tags.some(tag => tag.includes('蔬菜') || tag.includes('水果') || '蔬菜水果'.includes(tag)))
