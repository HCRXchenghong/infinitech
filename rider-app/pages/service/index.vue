    ...
    >
      ...
      >
        <image
          ...
          :src="msg.isSelf ? (avatarUrl || '/static/images/logo.png') : (msg.avatar || otherAvatar || '/static/images/logo.png')"
          mode="aspectFill"
        ></image>
        <view class="message-content">
          <view v-if="msg.officialIntervention" class="official-intervention">
          ...
          >
            ...
            <text class="order-card-shop">
              {{ msg.order && msg.order.shopName ? msg.order.shopName : '订单 #' + formatOrderNo(msg.order) }}
            </text>
          ...
          <view v-if="msg.isSelf" class="msg-status-row">
            ...
            <text v-else-if="msg.status === 'read'" class="msg-status read">已读</text>
            <text v-else-if="msg.status === 'sent'" class="msg-status sent">已发送</text>
          </view>
        </view>
      </view>
    </scroll-view>
