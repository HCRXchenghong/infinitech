<template>
  <view class="page category-page">
    <PageHeader title="汉堡披萨" :showSearch="true" @search="goSearch" />
...
export default {
  ...
  computed: {
    filteredShops() {
      ...
      shops = shops.filter(shop => shop.tags && shop.tags.some(tag => tag.includes('汉堡') || tag.includes('披萨') || '汉堡披萨'.includes(tag)))
