    ...
    <view class="modal-content" @tap.stop>
      ...
      <view class="modal-body">
        ...
        <view class="section-block" v-if="forecastList.length > 0">
          ...
          <view v-for="(item, idx) in forecastList" :key="idx" class="kv-row">
        ...
        <view class="section-block" v-if="hourlyList.length > 0">
          ...
          <view v-for="(item, idx) in hourlyPreviewList" :key="idx" class="kv-row">
        ...
        <view class="section-block" v-if="lifeIndexList.length > 0">
          ...
          <view v-for="(item, idx) in lifeIndexList" :key="idx" class="kv-row">
